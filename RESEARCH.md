...
**Data caveat:** All revenue/download figures are third-party *estimates* from app-intelligence firms (AppMagic, Sensor Tower, AppstoreSpy, Udonis) and publisher statements. AppMagic figures are **IAP-only net of store fees is not always specified, and ad revenue is generally NOT included** unless stated. Treat every number as directional, not audited.

---

## 1. Executive Market Snapshot

Hybrid-casual is the fastest-growing segment in mobile gaming:

| Metric (AppMagic) | Value |
|---|---|
| Top-10 hybrid-casual IAP revenue, Q1 2025 | ~$87M (+67% YoY) |
| Top-10 hybrid-casual IAP revenue, Q2 2025 | ~$126M (+100% YoY) |
| Segment IAP revenue (annualized comparison) | $390M → $733M (+88% YoY); Google Play +94%, App Store +84% |
| New competing titles launched Jan–Jul 2025 | 200+ |
| Genre mix of top-10 revenue (Q2'25) | Puzzle >50%, Arcade ~35% |

Puzzle sub-genres (block jam, screw/nuts-and-bolts, sort) staged a "great puzzle takeover" of the hybrid-casual charts in 2025, displacing runner/arcade-style hits. Rollic (Zynga), Voodoo, Homa, SayGames, and Vietnamese publishers (iKame, ABI) dominate.

### Top-10 Hybrid-Casual Games, Q2 2025 (AppMagic, IAP revenue)

| Rank | Game | Publisher | Q2'25 Revenue | Q2'25 Installs |
|---|---|---|---|---|
| 1 | Color Block Jam | Rollic | $42M | 21.8M |
| 2 | Screwdom | iKame Global* | $27.1M | 13.1M |
| 3 | All in Hole | Homa | $22.3M | 3.4M |
| 4 | Pocket Champs | Madbox | $8.2M | 4.9M |
| 5 | Mob Control | Voodoo | $6.5M | 24.3M |
| 6 | Hole People | Rollic | $4.9M | 2.5M |
| 7 | Screw Sort Puzzle – Cube Jam 3D | BitEpoch | $4.7M | 3.1M |
| 8 | Tower War – Tactical Conquest | SayGames | $3.5M | 9.5M |
| 9 | Epic Plane Evolution | Voodoo | $3.5M | 8.6M |
| 10 | Knit Out | Rollic | $3.4M | 1.5M |

*\*One syndicated summary of the AppMagic table listed Screwdom under Rollic; primary coverage (Sensor Tower, Gamigion, Lancaric) attributes Screwdom to iKame Global (Hanoi, Vietnam).*
...
|---|---|
| Launch | June 28, 2024 |
| Revenue (est.) | Q4'24: ~$175K → Q1'25: ~$25M → Q2'25: ~$42M. ~$87M IAP through H1'25; highest-grossing game in Rollic's history. Run-rate implies $150M+ lifetime IAP by mid-2026 (est.) |
...
### 2.2 Screwdom / Screwdom 3D (iKame Global)

| Attribute | Detail |
|---|---|
| Launch | Late 2024 (global scale-up Q1 2025) |
| Revenue (est.) | Q1'25: ~$3.6M; April 2025 alone: ~$6.7M; scaled toward ~$15M/month (IAP+ads) at peak per iKame case-study coverage; ~$27.1M IAP in Q2'25; $10M+ all-time IAP on Android alone within 7 months (Sensor Tower) |
| Downloads (est.) | Peaked at ~297K daily installs (Feb 8, 2025); cumulative in the tens of millions; iKame ranks top-20 global publisher by downloads |
| Core mechanic | 3D "screw puzzle": unscrew bolts from layered wooden boards in the right order; screws drop into color-matched collectors. Physics + occlusion create genuine spatial reasoning |
| Meta-layer | Level chains, boosters, daily missions, seasonal events, win-streak systems, collection/reward tracks |
...
|---|---|
| Launch | Mid-2023 |
| Revenue (est.) | ~$11.8M IAP Jul'23–Jun'24 (Statista); ~$15M IAP + 6M+ downloads by Sep'24; peak weekly revenue ~$615K (Q2'24); peak daily run-rate ~$250K/day ($150K+ IAP + $80K+ ads) per Two & a Half Gamers |
...
**Takeaway:** All in Hole is the cleanest proof of the hybrid-casual thesis: take a 2018 hyper-casual mechanic, bolt on a 2024 casual-puzzle liveops/IAP stack, and revenue per install multiplies ~10x.

### 2.5 Pocket Champs (Madbox)
...
| Meta-layer | Card/unit collection and upgrades, base progression, events, battle pass, PvP seasons, IP crossovers (Transformers collab spiked revenue) |
| Monetization mix | True hybrid mix: interstitials + rewarded video + IAP (cards, pass, offers). Roughly 50/50 ads/IAP historically, shifting toward IAP as meta deepened |
| Why it went viral | Multiplier-gate creatives are the most copied ad format in mobile ("choose the right gate"); TikTok Smart+ campaigns unlocked global markets (TikTok case study); instantly legible win condition |

**Takeaway:** Mob Control is the canonical hyper→hybrid conversion: same 15-second core, but cards/pass/events lifted LTV enough to sustain 5 years of UA.

### 2.7 Hexa Sort (Lion Studios / gamebra.in + Mindstorm)
...
**Takeaway:** ABI (alongside iKame) illustrates Vietnam's playbook: extreme download volume + ad monetization; Vietnamese studios drove ~40% of global game downloads by 2025 (VnExpress).

### 2.9 Tower War – Tactical Conquest (SayGames)

| Attribute | Detail |
|---|---|
| Launch | 2021 |
| Downloads (est.) | 100M+ on Google Play (store-listed); still ~3M/month on Android + ~500K/month iOS in 2025 (Sensor Tower est.) |
...
### 2.10 My Perfect Hotel (SayGames)
...
## 3. What "Hybrid-Casual" Actually Means

**Definition:** Hybrid-casual = **hyper-casual acquisition economics + casual/mid-core retention & monetization systems.**
...
Estimates compiled from Tap Nation, AppSamurai, Admiral Media, Gamigion/Lancaric, Liftoff, and Gamesforum reports. Ranges vary by geo (US vs T1 vs global) and sub-genre.

| KPI | Hyper-Casual (ref.) | **Hybrid-Casual target** | Notes |
|---|---|---|---|
| CPI (Android, blended) | $0.10–0.50 | **$0.30–1.50** (~$1.50 avg 2025) | Puzzle hybrids in US T1 can run $2–4 |
| CPI (iOS, blended) | $0.30–1.00 | **$1.50–3.50** (~$2.50 avg 2025) | |
| D1 retention | 25–35% | **35–45%** (min. viable ~30%) | <20% D1 = core loop broken, don't scale |
| D7 retention | 5–8% | **15–20%** | Single best leading indicator of LTV |
| D30 retention | 1–2% | **6–10%** (min. viable ~4%) | D30 >4% + D1 >30% ≈ viable unit economics |
| Session length | 1–3 min | **6–15 min** | |
| Sessions/day | 2–4 | **4–8** | Appointment liveops drive this |
| ARPDAU (blended, T1) | $0.05–0.10 | **$0.15–0.40** (top titles $0.50+) | |
| D30 ROAS | 30–70% (D3-focused) | **40–60%** (47% iOS / 15% Android casual avg) | Payback windows stretched to 90–180d |
| LTV (blended, global) | $0.20–0.60 | **$1.50–5.00**; US T1 puzzle hybrids $8–20+ | |
| Revenue split (IAP:Ads) | 0–10 : 90–100 | **40–60 IAP : 40–60 Ads** (50:50 is the UA-manager ideal) | Winners drift IAP-heavy over time (Color Block Jam, All in Hole) |
| IAP conversion (payer %) | <0.5% | **1.5–4%** of DAU | Fail-offers + starter packs do the work |

**Rules of thumb:**
- The business works when **LTV(D180) ≥ 3× CPI** and D30 ROAS ≥ ~40% on the way there.
- Rewarded-video engagement target: 30%+ of DAU watching ≥1 rewarded ad/day.
- Fail-level IAP offers (extra moves/continue) are the #1 IAP driver in puzzle hybrids; battle passes #2; ad-removal #3 (per AppMagic Q2'25 commentary).
...
9. **IP crossovers as revenue spikes.** Mob Control × Transformers demonstrated collab events as a repeatable revenue-spike tool for aging hybrids.
10. **Consolidation of the ad-only model's decline.** Pure hyper-casual continues shrinking; even download monsters (My Perfect Hotel, Wood Nuts & Bolts) retro-fit deeper metas to survive.
